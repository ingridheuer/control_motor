...
//Version para testear tiempo de ejecucion, saque todos los prints para que no interfera con el print del tiempo
...
PushButton endMicroswitch(homeSwitch, false, debounceDelay);
...
//=========================================
// Tratando de medir el tiempo de ejecucion
//=========================================
...
void gohome() {
  ...
  while (!homeMicroswitch.isOn()) {
    stepper.move(-1); //probar con distintos valores aca
    stepper.run();
  }
